...
public final class SupplierDao_Impl implements SupplierDao {
  ...
  public SupplierDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSupplier = new EntityInsertionAdapter<Supplier>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `supplier` (`id`,`nama`,`kontak`,`alamat`) VALUES (nullif(?, 0),?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(3, entity.getKontak());
    ...
    this.__updateAdapterOfSupplier = new EntityDeletionOrUpdateAdapter<Supplier>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `supplier` SET `id` = ?,`nama` = ?,`kontak` = ?,`alamat` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object insert(final Supplier item, final Continuation<? super Long> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Long>() {
      ...
      public Long call() throws Exception {
        ...
        try {
          final Long _result = __insertionAdapterOfSupplier.insertAndReturnId(item);
  ...
  @Override
  public Object delete(final Supplier item, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __deletionAdapterOfSupplier.handle(item);
          __db.setTransactionSuccessful();
  ...
  @Override
  public Object update(final Supplier item, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __updateAdapterOfSupplier.handle(item);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Flow<List<Supplier>> getAll() {
    final String _sql = "SELECT * FROM supplier ORDER BY nama ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"supplier"}, new Callable<List<Supplier>>() {
      @Override
      @NonNull
      public List<Supplier> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfKontak = CursorUtil.getColumnIndexOrThrow(_cursor, "kontak");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpKontak;
            _tmpKontak = _cursor.getString(_cursorIndexOfKontak);
            final String _tmpAlamat;
            _tmpAlamat = _cursor.getString(_cursorIndexOfAlamat);
            _item = new Supplier(_tmpId,_tmpNama,_tmpKontak,_tmpAlamat);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Object count(final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM supplier";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
